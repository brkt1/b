          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 rounded-xl p-8 backdrop-blur-sm border border-white/10">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-secondary flex items-center justify-center text-xl font-bold mr-4">JD</div>
                <div>
                  <h4 className="font-bold">Jane Doe</h4>
                  <p className="text-sm opacity-80">Director, Global Initiatives</p>
                </div>
              </div>
              <p className="italic mb-4">
                "Biruhminds transformed our approach to market research, delivering insights that directly impacted our bottom line."
              </p>
            ...
            <div className="bg-white/10 rounded-xl p-8 backdrop-blur-sm border border-white/10">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-secondary flex items-center justify-center text-xl font-bold mr-4">AS</div>
                <div>
                  <h4 className="font-bold">Adam Smith</h4>
                  <p className="text-sm opacity-80">CEO, TechForward</p>
                </div>
              </div>
              <p className="italic mb-4">
                "The training program exceeded all expectations. Our team's performance improved by 40% within months."
              </p>
              <div className="flex text-yellow-400">
                <i className="fas fa-star"></i>
                <i className="fas fa-star"></i>
            ...
            <div className="bg-white/10 rounded-xl p-8 backdrop-blur-sm border border-white/10">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-secondary flex items-center justify-center text-xl font-bold mr-4">ME</div>
                <div>
                  <h4 className="font-bold">Maria E.</h4>
                  <p className="text-sm opacity-80">Policy Advisor</p>
                </div>
              </div>
              <p className="italic mb-4">
                "Their policy recommendations were instrumental in shaping our new sustainability framework."
              </p>
              <div className="flex text-yellow-400">
                <i className="fas fa-star"></i>
                <i className="fas fa-star"></i>
